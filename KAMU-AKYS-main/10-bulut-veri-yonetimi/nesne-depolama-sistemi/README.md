...
Bu modül **uulut veri yonetimi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **nesne depolama sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan nesne depolama sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
