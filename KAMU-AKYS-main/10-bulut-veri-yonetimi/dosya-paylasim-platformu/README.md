# dosya paylasim platformu

Bu modül **uulut veri yonetimi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **dosya paylasim platformu** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan dosya paylasim platformu çözümünü açık kaynak olarak sunmayı hedeflemektedir.
