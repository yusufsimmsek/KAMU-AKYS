...
Bu modül **uulut veri yonetimi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **konteyner orkestrasyon sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan konteyner orkestrasyon sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
