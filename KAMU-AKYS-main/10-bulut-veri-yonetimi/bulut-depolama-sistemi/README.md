# uulut depolama sistemi

Bu modül **uulut veri yonetimi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **uulut depolama sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan uulut depolama sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
