# uulut hesaplama platformu

Bu modül **uulut veri yonetimi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **uulut hesaplama platformu** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan uulut hesaplama platformu çözümünü açık kaynak olarak sunmayı hedeflemektedir.
