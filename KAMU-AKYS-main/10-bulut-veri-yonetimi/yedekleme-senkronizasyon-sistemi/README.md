# yedekleme senkronizasyon sistemi

Bu modül **uulut veri yonetimi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **yedekleme senkronizasyon sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan yedekleme senkronizasyon sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
