...
Bu modül **e ogrenme egitim** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **uzaktan egitim platformu** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan uzaktan egitim platformu çözümünü açık kaynak olarak sunmayı hedeflemektedir.
