...
Bu modül **e ogrenme egitim** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **dijital kutuphane** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan dijital kutuphane çözümünü açık kaynak olarak sunmayı hedeflemektedir.
