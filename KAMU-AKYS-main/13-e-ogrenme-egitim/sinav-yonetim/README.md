...
Bu modül **e ogrenme egitim** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **sinav yonetim** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan sinav yonetim çözümünü açık kaynak olarak sunmayı hedeflemektedir.
