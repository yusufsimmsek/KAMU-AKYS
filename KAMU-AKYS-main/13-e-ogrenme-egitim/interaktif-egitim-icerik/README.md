# interaktif egitim icerik

Bu modül **e ogrenme egitim** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **interaktif egitim icerik** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan interaktif egitim icerik çözümünü açık kaynak olarak sunmayı hedeflemektedir.
