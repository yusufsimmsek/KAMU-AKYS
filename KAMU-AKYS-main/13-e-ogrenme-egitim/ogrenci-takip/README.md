...
Bu modül **e ogrenme egitim** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **ogrenci takip** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan ogrenci takip çözümünü açık kaynak olarak sunmayı hedeflemektedir.
