# guvenlik kamera analitik

Bu modül **ozel guvenlik istihuarat** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **guvenlik kamera analitik** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan guvenlik kamera analitik çözümünü açık kaynak olarak sunmayı hedeflemektedir.
