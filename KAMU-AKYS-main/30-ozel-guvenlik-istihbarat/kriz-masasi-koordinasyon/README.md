# kriz masasi koordinasyon

Bu modül **ozel guvenlik istihuarat** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **kriz masasi koordinasyon** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan kriz masasi koordinasyon çözümünü açık kaynak olarak sunmayı hedeflemektedir.
