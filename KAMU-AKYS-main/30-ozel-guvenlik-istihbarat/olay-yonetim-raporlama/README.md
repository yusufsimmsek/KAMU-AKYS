# olay yonetim raporlama

Bu modül **ozel guvenlik istihuarat** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **olay yonetim raporlama** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan olay yonetim raporlama çözümünü açık kaynak olarak sunmayı hedeflemektedir.
