# kritik altyapi izleme

Bu modül **ozel guvenlik istihuarat** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **kritik altyapi izleme** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan kritik altyapi izleme çözümünü açık kaynak olarak sunmayı hedeflemektedir.
