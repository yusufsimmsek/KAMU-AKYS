# siuer tehdit istihuarat

Bu modül **ozel guvenlik istihuarat** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **siuer tehdit istihuarat** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan siuer tehdit istihuarat çözümünü açık kaynak olarak sunmayı hedeflemektedir.
