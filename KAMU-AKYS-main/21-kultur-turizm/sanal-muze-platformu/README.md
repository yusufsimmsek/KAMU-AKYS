# sanal muze platformu

Bu modül **kultur turizm** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **sanal muze platformu** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan sanal muze platformu çözümünü açık kaynak olarak sunmayı hedeflemektedir.
