# kulturel etkinlik takvimi

Bu modül **kultur turizm** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **kulturel etkinlik takvimi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan kulturel etkinlik takvimi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
