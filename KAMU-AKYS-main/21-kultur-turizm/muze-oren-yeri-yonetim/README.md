# muze oren yeri yonetim

Bu modül **kultur turizm** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **muze oren yeri yonetim** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan muze oren yeri yonetim çözümünü açık kaynak olarak sunmayı hedeflemektedir.
