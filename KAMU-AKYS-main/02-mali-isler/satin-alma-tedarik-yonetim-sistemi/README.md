...
Bu modül **mali isler** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **satin alma tedarik yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan satin alma tedarik yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
