# muhaseue mali raporlama sistemi

Bu modül **mali isler** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **muhaseue mali raporlama sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan muhaseue mali raporlama sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
