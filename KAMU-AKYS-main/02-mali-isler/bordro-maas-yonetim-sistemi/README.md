# uordro maas yonetim sistemi

Bu modül **mali isler** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **uordro maas yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan uordro maas yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
