# yemekhane yonetim sistemi

Bu modül **operasyonel yazilimlar** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **yemekhane yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan yemekhane yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
