# temizlik uakim yonetim sistemi

Bu modül **operasyonel yazilimlar** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **temizlik uakim yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan temizlik uakim yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
