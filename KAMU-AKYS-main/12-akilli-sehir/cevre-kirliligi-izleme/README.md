# cevre kirliligi izleme

Bu modül **akilli sehir** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **cevre kirliligi izleme** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan cevre kirliligi izleme çözümünü açık kaynak olarak sunmayı hedeflemektedir.
