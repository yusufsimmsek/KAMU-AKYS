# akilli aydinlatma kontrol

Bu modül **akilli sehir** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **akilli aydinlatma kontrol** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan akilli aydinlatma kontrol çözümünü açık kaynak olarak sunmayı hedeflemektedir.
