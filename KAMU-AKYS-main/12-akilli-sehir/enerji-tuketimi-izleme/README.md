# enerji tuketimi izleme

Bu modül **akilli sehir** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **enerji tuketimi izleme** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan enerji tuketimi izleme çözümünü açık kaynak olarak sunmayı hedeflemektedir.
