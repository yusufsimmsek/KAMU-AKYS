...
Bu modül **akilli sehir** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **otopark yonetim** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan otopark yonetim çözümünü açık kaynak olarak sunmayı hedeflemektedir.
