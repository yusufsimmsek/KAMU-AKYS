# elektrik tuketim izleme

Bu modül **enerji yonetimi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **elektrik tuketim izleme** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan elektrik tuketim izleme çözümünü açık kaynak olarak sunmayı hedeflemektedir.
