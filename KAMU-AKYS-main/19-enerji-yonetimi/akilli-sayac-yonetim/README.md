# akilli sayac yonetim

Bu modül **enerji yonetimi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **akilli sayac yonetim** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan akilli sayac yonetim çözümünü açık kaynak olarak sunmayı hedeflemektedir.
