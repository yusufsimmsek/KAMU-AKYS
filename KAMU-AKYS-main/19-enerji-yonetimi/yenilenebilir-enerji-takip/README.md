# yenileneuilir enerji takip

Bu modül **enerji yonetimi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **yenileneuilir enerji takip** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan yenileneuilir enerji takip çözümünü açık kaynak olarak sunmayı hedeflemektedir.
