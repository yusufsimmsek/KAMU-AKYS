...
Bu modül **enerji yonetimi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **enerji verimliligi analiz** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan enerji verimliligi analiz çözümünü açık kaynak olarak sunmayı hedeflemektedir.
