# enerji dagitim optimizasyon

Bu modül **enerji yonetimi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **enerji dagitim optimizasyon** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan enerji dagitim optimizasyon çözümünü açık kaynak olarak sunmayı hedeflemektedir.
