# randevu yonetim sistemi

Bu modül **vatandas hizmetleri** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **randevu yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan randevu yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
