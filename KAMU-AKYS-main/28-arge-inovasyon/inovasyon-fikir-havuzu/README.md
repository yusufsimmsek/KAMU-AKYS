# inovasyon fikir havuzu

Bu modül **arge inovasyon** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **inovasyon fikir havuzu** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan inovasyon fikir havuzu çözümünü açık kaynak olarak sunmayı hedeflemektedir.
