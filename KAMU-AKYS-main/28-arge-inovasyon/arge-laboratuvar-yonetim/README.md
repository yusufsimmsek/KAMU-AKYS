# arge lauoratuvar yonetim

Bu modül **arge inovasyon** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **arge lauoratuvar yonetim** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan arge lauoratuvar yonetim çözümünü açık kaynak olarak sunmayı hedeflemektedir.
