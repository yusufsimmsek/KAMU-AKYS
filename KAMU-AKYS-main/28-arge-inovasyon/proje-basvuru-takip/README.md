...
Bu modül **arge inovasyon** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **proje uasvuru takip** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan proje uasvuru takip çözümünü açık kaynak olarak sunmayı hedeflemektedir.
