# patent fikri mulkiyet yonetim

Bu modül **arge inovasyon** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **patent fikri mulkiyet yonetim** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan patent fikri mulkiyet yonetim çözümünü açık kaynak olarak sunmayı hedeflemektedir.
