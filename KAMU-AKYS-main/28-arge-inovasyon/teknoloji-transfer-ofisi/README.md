...
Bu modül **arge inovasyon** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **teknoloji transfer ofisi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan teknoloji transfer ofisi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
