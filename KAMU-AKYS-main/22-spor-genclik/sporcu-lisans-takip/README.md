...
Bu modül **spor genclik** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **sporcu lisans takip** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan sporcu lisans takip çözümünü açık kaynak olarak sunmayı hedeflemektedir.
