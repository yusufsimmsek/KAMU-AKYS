...
Bu modül **spor genclik** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **antrenor egitim takip** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan antrenor egitim takip çözümünü açık kaynak olarak sunmayı hedeflemektedir.
