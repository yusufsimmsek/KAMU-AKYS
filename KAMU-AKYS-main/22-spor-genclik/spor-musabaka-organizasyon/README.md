# spor musauaka organizasyon

Bu modül **spor genclik** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **spor musauaka organizasyon** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan spor musauaka organizasyon çözümünü açık kaynak olarak sunmayı hedeflemektedir.
