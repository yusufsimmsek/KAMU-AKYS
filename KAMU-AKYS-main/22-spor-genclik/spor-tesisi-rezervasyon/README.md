# spor tesisi rezervasyon

Bu modül **spor genclik** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **spor tesisi rezervasyon** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan spor tesisi rezervasyon çözümünü açık kaynak olarak sunmayı hedeflemektedir.
