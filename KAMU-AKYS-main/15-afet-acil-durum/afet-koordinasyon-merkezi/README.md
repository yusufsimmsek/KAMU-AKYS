...
Bu modül **afet acil durum** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **afet koordinasyon merkezi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan afet koordinasyon merkezi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
