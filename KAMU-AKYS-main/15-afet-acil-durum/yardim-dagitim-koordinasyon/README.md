# yardim dagitim koordinasyon

Bu modül **afet acil durum** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **yardim dagitim koordinasyon** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan yardim dagitim koordinasyon çözümünü açık kaynak olarak sunmayı hedeflemektedir.
