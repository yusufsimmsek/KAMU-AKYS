...
Bu modül **afet acil durum** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **risk haritalama** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan risk haritalama çözümünü açık kaynak olarak sunmayı hedeflemektedir.
