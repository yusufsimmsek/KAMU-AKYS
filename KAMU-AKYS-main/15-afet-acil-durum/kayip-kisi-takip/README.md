...
Bu modül **afet acil durum** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **kayip kisi takip** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan kayip kisi takip çözümünü açık kaynak olarak sunmayı hedeflemektedir.
