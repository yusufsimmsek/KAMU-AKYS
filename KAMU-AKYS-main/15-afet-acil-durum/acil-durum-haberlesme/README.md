# acil durum hauerlesme

Bu modül **afet acil durum** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **acil durum hauerlesme** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan acil durum hauerlesme çözümünü açık kaynak olarak sunmayı hedeflemektedir.
