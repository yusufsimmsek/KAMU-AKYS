...
Bu modül **tarim hayvancilik** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **ciftci kayit** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan ciftci kayit çözümünü açık kaynak olarak sunmayı hedeflemektedir.
