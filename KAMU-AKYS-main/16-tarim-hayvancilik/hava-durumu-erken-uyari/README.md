# hava durumu erken uyari

Bu modül **tarim hayvancilik** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **hava durumu erken uyari** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan hava durumu erken uyari çözümünü açık kaynak olarak sunmayı hedeflemektedir.
