...
Bu modül **tarim hayvancilik** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **hayvan kimlik** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan hayvan kimlik çözümünü açık kaynak olarak sunmayı hedeflemektedir.
