# urun takip izleneuilirlik

Bu modül **tarim hayvancilik** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **urun takip izleneuilirlik** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan urun takip izleneuilirlik çözümünü açık kaynak olarak sunmayı hedeflemektedir.
