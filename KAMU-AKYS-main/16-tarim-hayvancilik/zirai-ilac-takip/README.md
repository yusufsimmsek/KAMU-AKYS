...
Bu modül **tarim hayvancilik** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **zirai ilac takip** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan zirai ilac takip çözümünü açık kaynak olarak sunmayı hedeflemektedir.
