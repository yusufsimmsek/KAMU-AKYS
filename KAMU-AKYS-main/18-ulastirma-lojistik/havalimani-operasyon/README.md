# havalimani operasyon

Bu modül **ulastirma lojistik** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **havalimani operasyon** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan havalimani operasyon çözümünü açık kaynak olarak sunmayı hedeflemektedir.
