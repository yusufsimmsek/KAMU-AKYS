# arac takip rota optimizasyon

Bu modül **ulastirma lojistik** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **arac takip rota optimizasyon** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan arac takip rota optimizasyon çözümünü açık kaynak olarak sunmayı hedeflemektedir.
