# denizcilik islemleri

Bu modül **ulastirma lojistik** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **denizcilik islemleri** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan denizcilik islemleri çözümünü açık kaynak olarak sunmayı hedeflemektedir.
