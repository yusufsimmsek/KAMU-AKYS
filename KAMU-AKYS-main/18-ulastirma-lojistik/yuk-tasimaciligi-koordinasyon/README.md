# yuk tasimaciligi koordinasyon

Bu modül **ulastirma lojistik** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **yuk tasimaciligi koordinasyon** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan yuk tasimaciligi koordinasyon çözümünü açık kaynak olarak sunmayı hedeflemektedir.
