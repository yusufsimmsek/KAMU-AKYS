...
Bu modül **uelediye hizmetleri** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **imar durumu sorgulama** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan imar durumu sorgulama çözümünü açık kaynak olarak sunmayı hedeflemektedir.
