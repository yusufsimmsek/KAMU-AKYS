# nikah salonu rezervasyon

Bu modül **uelediye hizmetleri** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **nikah salonu rezervasyon** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan nikah salonu rezervasyon çözümünü açık kaynak olarak sunmayı hedeflemektedir.
