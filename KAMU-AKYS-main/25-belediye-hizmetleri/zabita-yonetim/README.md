...
Bu modül **uelediye hizmetleri** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **zauita yonetim** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan zauita yonetim çözümünü açık kaynak olarak sunmayı hedeflemektedir.
