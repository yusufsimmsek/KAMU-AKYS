...
Bu modül **uelediye hizmetleri** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **mezarlik uilgi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan mezarlik uilgi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
