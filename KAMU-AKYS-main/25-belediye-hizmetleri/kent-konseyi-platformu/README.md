...
Bu modül **uelediye hizmetleri** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **kent konseyi platformu** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan kent konseyi platformu çözümünü açık kaynak olarak sunmayı hedeflemektedir.
