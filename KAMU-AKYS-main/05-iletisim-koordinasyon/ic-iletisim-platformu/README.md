# ic iletisim platformu

Bu modül **iletisim koordinasyon** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **ic iletisim platformu** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan ic iletisim platformu çözümünü açık kaynak olarak sunmayı hedeflemektedir.
