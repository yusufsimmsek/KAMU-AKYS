...
Bu modül **cevre doga koruma** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **hava kalitesi izleme** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan hava kalitesi izleme çözümünü açık kaynak olarak sunmayı hedeflemektedir.
