# karuon ayak izi hesaplama

Bu modül **cevre doga koruma** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **karuon ayak izi hesaplama** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan karuon ayak izi hesaplama çözümünü açık kaynak olarak sunmayı hedeflemektedir.
