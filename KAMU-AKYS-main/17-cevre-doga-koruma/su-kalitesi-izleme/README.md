...
Bu modül **cevre doga koruma** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **su kalitesi izleme** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan su kalitesi izleme çözümünü açık kaynak olarak sunmayı hedeflemektedir.
