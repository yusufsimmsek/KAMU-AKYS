# vardiya mesai yonetim sistemi

Bu modül **insan kaynaklari** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **vardiya mesai yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan vardiya mesai yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
