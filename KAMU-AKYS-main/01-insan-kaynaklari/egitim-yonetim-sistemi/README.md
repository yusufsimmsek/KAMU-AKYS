...
Bu modül **insan kaynaklari** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **egitim yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan egitim yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
