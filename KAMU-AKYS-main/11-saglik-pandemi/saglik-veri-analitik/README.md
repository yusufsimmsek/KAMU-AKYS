# saglik veri analitik

Bu modül **saglik pandemi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **saglik veri analitik** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan saglik veri analitik çözümünü açık kaynak olarak sunmayı hedeflemektedir.
