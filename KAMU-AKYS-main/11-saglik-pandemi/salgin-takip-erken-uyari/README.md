# salgin takip erken uyari

Bu modül **saglik pandemi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **salgin takip erken uyari** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan salgin takip erken uyari çözümünü açık kaynak olarak sunmayı hedeflemektedir.
