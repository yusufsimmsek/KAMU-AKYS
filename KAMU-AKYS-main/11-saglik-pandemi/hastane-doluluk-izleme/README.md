# hastane doluluk izleme

Bu modül **saglik pandemi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **hastane doluluk izleme** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan hastane doluluk izleme çözümünü açık kaynak olarak sunmayı hedeflemektedir.
