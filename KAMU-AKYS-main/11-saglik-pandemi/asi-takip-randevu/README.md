...
Bu modül **saglik pandemi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **asi takip randevu** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan asi takip randevu çözümünü açık kaynak olarak sunmayı hedeflemektedir.
