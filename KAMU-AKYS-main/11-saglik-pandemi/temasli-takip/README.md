...
Bu modül **saglik pandemi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **temasli takip** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan temasli takip çözümünü açık kaynak olarak sunmayı hedeflemektedir.
