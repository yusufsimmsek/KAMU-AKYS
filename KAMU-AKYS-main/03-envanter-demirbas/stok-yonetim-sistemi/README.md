...
Bu modül **envanter demiruas** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **stok yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan stok yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
