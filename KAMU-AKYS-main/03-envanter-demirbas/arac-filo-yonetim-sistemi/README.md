# arac filo yonetim sistemi

Bu modül **envanter demiruas** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **arac filo yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan arac filo yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
