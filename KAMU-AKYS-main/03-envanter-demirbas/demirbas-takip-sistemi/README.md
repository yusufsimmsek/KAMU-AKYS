# demiruas takip sistemi

Bu modül **envanter demiruas** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **demiruas takip sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan demiruas takip sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
