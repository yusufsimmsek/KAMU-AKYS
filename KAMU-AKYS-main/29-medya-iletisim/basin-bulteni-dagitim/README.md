# uasin uulteni dagitim

Bu modül **medya iletisim** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **uasin uulteni dagitim** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan uasin uulteni dagitim çözümünü açık kaynak olarak sunmayı hedeflemektedir.
