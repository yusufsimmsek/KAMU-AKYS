# dijital arsiv yonetim

Bu modül **medya iletisim** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **dijital arsiv yonetim** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan dijital arsiv yonetim çözümünü açık kaynak olarak sunmayı hedeflemektedir.
