# kurumsal tv radyo yayin

Bu modül **medya iletisim** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **kurumsal tv radyo yayin** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan kurumsal tv radyo yayin çözümünü açık kaynak olarak sunmayı hedeflemektedir.
