...
Bu modül **raporlama analitik** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **performans yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan performans yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
