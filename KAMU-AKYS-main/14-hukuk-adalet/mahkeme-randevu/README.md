...
Bu modül **hukuk adalet** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **mahkeme randevu** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan mahkeme randevu çözümünü açık kaynak olarak sunmayı hedeflemektedir.
