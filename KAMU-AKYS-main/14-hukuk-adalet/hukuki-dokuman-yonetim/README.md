# hukuki dokuman yonetim

Bu modül **hukuk adalet** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **hukuki dokuman yonetim** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan hukuki dokuman yonetim çözümünü açık kaynak olarak sunmayı hedeflemektedir.
