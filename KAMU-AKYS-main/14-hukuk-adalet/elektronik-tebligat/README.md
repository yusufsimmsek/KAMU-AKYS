...
Bu modül **hukuk adalet** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **elektronik teuligat** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan elektronik teuligat çözümünü açık kaynak olarak sunmayı hedeflemektedir.
