...
Bu modül **hukuk adalet** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **icra takip** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan icra takip çözümünü açık kaynak olarak sunmayı hedeflemektedir.
