...
Bu modül **hukuk adalet** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **dava takip** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan dava takip çözümünü açık kaynak olarak sunmayı hedeflemektedir.
