# gumruk islemleri otomasyon

Bu modül **gumruk ticaret** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **gumruk islemleri otomasyon** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan gumruk islemleri otomasyon çözümünü açık kaynak olarak sunmayı hedeflemektedir.
