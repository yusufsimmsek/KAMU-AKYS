# ticaret sicili yonetim

Bu modül **gumruk ticaret** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **ticaret sicili yonetim** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan ticaret sicili yonetim çözümünü açık kaynak olarak sunmayı hedeflemektedir.
