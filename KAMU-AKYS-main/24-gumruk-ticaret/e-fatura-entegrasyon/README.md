...
Bu modül **gumruk ticaret** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **e fatura entegrasyon** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan e fatura entegrasyon çözümünü açık kaynak olarak sunmayı hedeflemektedir.
