# dis ticaret istatistik

Bu modül **gumruk ticaret** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **dis ticaret istatistik** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan dis ticaret istatistik çözümünü açık kaynak olarak sunmayı hedeflemektedir.
