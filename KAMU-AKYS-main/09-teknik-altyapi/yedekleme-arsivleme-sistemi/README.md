# yedekleme arsivleme sistemi

Bu modül **teknik altyapi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **yedekleme arsivleme sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan yedekleme arsivleme sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
