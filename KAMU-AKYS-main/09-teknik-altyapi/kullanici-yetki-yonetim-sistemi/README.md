# kullanici yetki yonetim sistemi

Bu modül **teknik altyapi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **kullanici yetki yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan kullanici yetki yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
