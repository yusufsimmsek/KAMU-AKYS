# sistem izleme yonetim sistemi

Bu modül **teknik altyapi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **sistem izleme yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan sistem izleme yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
