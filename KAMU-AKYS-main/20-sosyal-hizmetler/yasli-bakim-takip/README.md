...
Bu modül **sosyal hizmetler** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **yasli uakim takip** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan yasli uakim takip çözümünü açık kaynak olarak sunmayı hedeflemektedir.
