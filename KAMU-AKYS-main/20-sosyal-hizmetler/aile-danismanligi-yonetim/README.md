# aile danismanligi yonetim

Bu modül **sosyal hizmetler** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **aile danismanligi yonetim** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan aile danismanligi yonetim çözümünü açık kaynak olarak sunmayı hedeflemektedir.
