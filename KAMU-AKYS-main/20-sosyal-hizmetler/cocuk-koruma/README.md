...
Bu modül **sosyal hizmetler** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **cocuk koruma** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan cocuk koruma çözümünü açık kaynak olarak sunmayı hedeflemektedir.
