# engelli vatandas hizmetleri

Bu modül **sosyal hizmetler** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **engelli vatandas hizmetleri** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan engelli vatandas hizmetleri çözümünü açık kaynak olarak sunmayı hedeflemektedir.
