...
Bu modül **vergi gelir yonetimi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **e haciz** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan e haciz çözümünü açık kaynak olarak sunmayı hedeflemektedir.
