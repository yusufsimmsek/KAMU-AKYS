...
Bu modül **vergi gelir yonetimi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **tahsilat takip** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan tahsilat takip çözümünü açık kaynak olarak sunmayı hedeflemektedir.
