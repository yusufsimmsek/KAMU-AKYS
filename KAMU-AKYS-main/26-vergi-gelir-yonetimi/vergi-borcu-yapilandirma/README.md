# vergi uorcu yapilandirma

Bu modül **vergi gelir yonetimi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **vergi uorcu yapilandirma** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan vergi uorcu yapilandirma çözümünü açık kaynak olarak sunmayı hedeflemektedir.
