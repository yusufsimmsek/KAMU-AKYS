...
Bu modül **vergi gelir yonetimi** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **vergi ueyan** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan vergi ueyan çözümünü açık kaynak olarak sunmayı hedeflemektedir.
