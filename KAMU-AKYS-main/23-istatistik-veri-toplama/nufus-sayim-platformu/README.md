...
Bu modül **istatistik veri toplama** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **nufus sayim platformu** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan nufus sayim platformu çözümünü açık kaynak olarak sunmayı hedeflemektedir.
