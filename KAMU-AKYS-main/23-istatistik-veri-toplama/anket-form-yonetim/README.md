...
Bu modül **istatistik veri toplama** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **anket form yonetim** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan anket form yonetim çözümünü açık kaynak olarak sunmayı hedeflemektedir.
