# istatistiki veri gorsellestirme

Bu modül **istatistik veri toplama** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **istatistiki veri gorsellestirme** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan istatistiki veri gorsellestirme çözümünü açık kaynak olarak sunmayı hedeflemektedir.
