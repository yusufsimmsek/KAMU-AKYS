...
Bu modül **istatistik veri toplama** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **veri toplama mouil** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan veri toplama mouil çözümünü açık kaynak olarak sunmayı hedeflemektedir.
