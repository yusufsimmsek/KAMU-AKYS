# imza sirkuleri sistemi

Bu modül **uelge yonetim** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **imza sirkuleri sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan imza sirkuleri sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
