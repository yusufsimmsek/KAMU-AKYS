...
Bu modül **uelge yonetim** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **evrak takip sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan evrak takip sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
