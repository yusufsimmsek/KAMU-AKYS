...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-&psk#e@k$w5n3kc!xa7^x1$6^4y#f_c@9v&(h&^%$#@2xa5@8')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'document_management_db'),
...
DOCUMENT_ALLOWED_EXTENSIONS = [
    ...
    'txt', 'odt', 'ods', 'odp', 'jpg', 'jpeg', 'png', 
    'gif', 'bmp', 'tiff', 'zip', 'rar'
]
