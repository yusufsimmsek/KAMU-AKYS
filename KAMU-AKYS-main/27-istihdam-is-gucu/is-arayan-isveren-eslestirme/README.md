# is arayan isveren eslestirme

Bu modül **istihdam is gucu** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **is arayan isveren eslestirme** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan is arayan isveren eslestirme çözümünü açık kaynak olarak sunmayı hedeflemektedir.
