# staj isuasi egitim takip

Bu modül **istihdam is gucu** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **staj isuasi egitim takip** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan staj isuasi egitim takip çözümünü açık kaynak olarak sunmayı hedeflemektedir.
