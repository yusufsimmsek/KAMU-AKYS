# mesleki yeterlilik takip

Bu modül **istihdam is gucu** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **mesleki yeterlilik takip** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan mesleki yeterlilik takip çözümünü açık kaynak olarak sunmayı hedeflemektedir.
