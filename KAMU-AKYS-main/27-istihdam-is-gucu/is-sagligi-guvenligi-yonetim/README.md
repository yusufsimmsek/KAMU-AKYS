# is sagligi guvenligi yonetim

Bu modül **istihdam is gucu** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **is sagligi guvenligi yonetim** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan is sagligi guvenligi yonetim çözümünü açık kaynak olarak sunmayı hedeflemektedir.
