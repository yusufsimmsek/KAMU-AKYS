# issizlik sigortasi yonetim

Bu modül **istihdam is gucu** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **issizlik sigortasi yonetim** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan issizlik sigortasi yonetim çözümünü açık kaynak olarak sunmayı hedeflemektedir.
